...
checkresiduals(ARIMA_Four_model2011)
...
## Select the best model with the minimum RMSE

```{r}

#create data frame
seas_scores <- as.data.frame(rbind(ETS_scores, ARIMA_Four_scores, NN_scores1))
row.names(seas_scores) <- c("STL-ETS", "ARIMA_FOUR","NEU-NETWORK")
