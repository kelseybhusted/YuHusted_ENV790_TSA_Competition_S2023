...
ETS_scores_for <- accuracy(ETS_model2011$mean,observed)
...
n_for <- 59
observed <- df_processed2010[(nobs-n_for+1):nobs, "Daily_data"]
TBATS_scores_for <- accuracy(TBATS_for$mean,observed)
...
n_for <- 59
observed <- df_processed2010[(nobs-n_for+1):nobs, "Daily_data"]
ARIMA_Four_scores_for <- accuracy(ARIMA_Four_for$mean,observed)
